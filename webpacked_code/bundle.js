	...
	var NinjaComponent = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(NinjaTitle, { title: 'React Ninja', __self: this
	      }),
	      React.createElement(NinjaTitle, { title: 'Angular Ninja', __self: this
	      }),
	      React.createElement(NinjaTitle, { title: 'Backbone Ninja', __self: this
	      }),
	      React.createElement(NinjaTitle, { title: 'jQuery Ninja', __self: this
	      })
	    );
	  }
	});

	ReactDOM.render(React.createElement(NinjaComponent, {
	  __self: this
